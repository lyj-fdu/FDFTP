...
- 理清了异常状况出现的全部细节
  - 客户端建立连接：对于3次握手的第1次，客户端向服务器欢迎套接字发送issyn，服务器欢迎套接字如果收到issyn就会发给客户端issyn，即3次握手的第2次，但客户端可能没收到回复的issyn，会卡住，此时直接终止客户端即可，不影响服务器。对于3次握手的第3次，客户端向服务器连接套接字发送issyn，服务器连接套接字如果收到issyn就会发给客户端issyn，但服务器连接套接字可能没收到issyn，但这不影响，因为客户端马上会上传一个带有延迟和最大接收窗口的文件，保证与服务器连接。
